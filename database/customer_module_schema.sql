...
INSERT INTO client_addresses (client_id, label, address_line, city, neighborhood, is_default) VALUES
(1, 'casa', 'Calle 15 #8-32, Barrio El Centro', 'Florencia', 'El Centro', 1),
(1, 'trabajo', 'Carrera 12 #20-15, Oficina 201', 'Florencia', 'La Vega', 0),
(2, 'casa', 'Avenida Circunvalar #5-90', 'Florencia', 'Torasso', 1),
(4, 'casa', 'Calle 8 #14-55, Barrio Porvenir', 'Florencia', 'El Porvenir', 1);

-- PQRSF de ejemplo
INSERT INTO pqrsf (client_id, radicado, tipo, asunto, descripcion, estado, prioridad) VALUES
(1, 'PQRSF-2026-0001', 'sugerencia', 'Horario extendido fines de semana', 'Seria muy util que la farmacia abriera hasta las 8pm los sabados para quienes trabajamos.', 'abierto', 'baja'),
(2, 'PQRSF-2026-0002', 'queja', 'Demora en entrega a domicilio', 'Mi pedido DOM-2026-003 tardo mas de 3 horas en llegar. El estimado era de 45 minutos.', 'en_proceso', 'alta'),
(1, 'PQRSF-2026-0003', 'felicitacion', 'Excelente atencion del personal', 'Quiero felicitar al cajero Carlos por su amabilidad y paciencia al explicarme mis medicamentos.', 'cerrado', 'baja'),
(3, 'PQRSF-2026-0004', 'reclamo', 'Producto vencido en estante', 'Encontre un producto con fecha de vencimiento pasada en la estanteria de vitaminas.', 'abierto', 'alta');

-- Reservas de ejemplo
INSERT INTO reservas (client_id, product_id, cantidad, estado) VALUES
(1, 4, 2, 'pendiente'),
(2, 10, 1, 'aprobada'),
(4, 7, 3, 'entregada');

-- Domicilios de ejemplo
INSERT INTO domicilios (client_id, sale_id, address_id, tipo_entrega, estado, costo_envio) VALUES
(1, 1, 1, 'inmediata', 'entregado', 5000.00),
(2, 2, 3, 'programada', 'despachado', 5000.00);

-- Notificaciones de ejemplo
INSERT INTO notificaciones (client_id, evento, titulo, mensaje, estado_envio, leida, referencia_tipo, referencia_id) VALUES
(1, 'compra_confirmada', 'Compra confirmada', 'Tu compra FV-2026-0001 por $31.000 ha sido procesada exitosamente.', 'enviado', 1, 'sales', 1),
(1, 'pqrsf_respuesta', 'PQRSF respondida', 'Tu felicitacion PQRSF-2026-0003 ha sido recibida y cerrada. Gracias por tus comentarios.', 'enviado', 0, 'pqrsf', 3),
(2, 'reserva_estado', 'Reserva aprobada', 'Tu reserva de Glibenclamida Genfar ha sido aprobada. Puedes recogerla en sucursal.', 'enviado', 0, 'reservas', 2),
(2, 'domicilio_estado', 'Pedido despachado', 'Tu pedido a domicilio ha sido despachado. Llegara pronto a tu direccion.', 'enviado', 0, 'domicilios', 2),
(4, 'compra_confirmada', 'Compra confirmada', 'Tu compra FV-2026-0003 por $89.000 ha sido procesada exitosamente.', 'enviado', 1, 'sales', 3);
